...
//       {data.map((item,index)=>{
//      return(
//       <Itemcard  isDisabled={item.isDisabled} id={item.id} image={item.image} name={item.name} rating={item.rating} price={item.price} key={index} data={data} setData={setData} item={item}/>
//      )
//       })}
